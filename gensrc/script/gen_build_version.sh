...
# Defaults produce version 4.1.2.1-4.4.0-0.
build_version_prefix="${DORIS_BUILD_VERSION_PREFIX-}"
...
build_version_rc_version="${DORIS_BUILD_VERSION_RC_VERSION-"4.4.0-0"}"

build_version="${build_version_prefix:+${build_version_prefix}-}${build_version_major}.${build_version_minor}.${build_version_patch}"
